...
function Previewpage1() {
  return (
    ...
    <div className="rightbox2">
      ...
      <div className="rightbox2-3"><a href={`https://branchofmee.github.io/portfolio22/index`} target='_blank' className="rightboxa nav-a "><i class="fa-solid fa-arrow-up-right-from-square"></i>사이트 가기!</a></div>
    </div>
    </Route>
  )
}
